...
export const EN_DICT: Record<string, string> = {
  ...
  "占线": "Busy",
  "进行中": "In progress",
  "还没有通话记录。通话结束后会自动出现在这里。":
    "No calls recorded yet. They appear here once a call ends.",
  "answered": "answered",
  "no_answer": "no answer",
  "busy": "busy",
  "cancelled": "cancelled",
  ...
  "IMS 未注册，将使用模组电路域拨号。电路域通话没有浏览器音频。": "IMS is not registered, so dialing falls back to the modem's circuit-switched path. Circuit-switched calls have no browser audio.",
  "号码，例如 +8613800138000": "Number, e.g. +8613800138000",
  "拨号": "Dial",
  "拨号失败": "Dial failed",
  "挂断": "Hang up",
  "挂断失败": "Hang-up failed",
  "接听 {number}": "Answer {number}",
  "接听失败": "Answer failed",
  "当前没有通话": "No call in progress",
  "拨号后这里会显示通话状态与音频桥接": "Call state and the audio bridge appear here once you dial",
  "编解码": "Codec",
  "媒体就绪": "Media ready",
  "连接音频": "Connect audio",
  "断开音频": "Disconnect audio",
  "静音": "Mute",
  "取消静音": "Unmute",
  "媒体尚未协商，收到带 SDP 的响应后即可连接音频。": "Media is not negotiated yet; audio can connect once a response carries SDP.",
  "下行": "RX",
  "上行": "TX",
  "已接收 {rx} 帧 · 已发送 {tx} 帧": "{rx} frames received · {tx} frames sent",
  "开始": "Started",
  ...
  // ---- 短信测试（SMS 投递测试）----
  "短信测试": "SMS Delivery Test",
  "通过外部网关发送带校验码的短信，并统计端到端到达情况": "Send a coded message through an external gateway and track end-to-end delivery",
  "统计": "Statistics",
  "测试计划": "Schedules",
  "接口配置": "Endpoints",
  "时间范围": "Time range",
  ...
  "耗时": "Elapsed",
  "接收设备": "Received on",
  "暂无测试结果": "No test results yet",
  "新建测试计划": "New schedule",
  "请先在「接口配置」中添加一个短信网关接口。": "Add an SMS gateway endpoint under Endpoints first.",
  "接收号码": "Recipient",
  "频率": "Frequency",
  "上次执行": "Last run",
  "暂无测试计划": "No schedules yet",
  "立即测试": "Run now",
  "新建接口": "New endpoint",
  "方法": "Method",
  "暂无接口配置": "No endpoints yet",
  "编辑接口": "Edit endpoint",
  "留空则保持不变": "Leave blank to keep the stored value",
  "请求头": "Headers",
  "请求体参数": "Body parameters",
  "可用占位符：{{username}}、{{password}}、{{to}}、{{from}}、{{content}}": "Placeholders: {{username}}, {{password}}, {{to}}, {{from}}, {{content}}",
  "编辑测试计划": "Edit schedule",
  "发送方标识": "Sender ID",
  "短信内容模板": "Message template",
  "{{code}} 会被替换为随机校验码，用于匹配收到的短信。": "{{code}} is replaced with a random code used to match the received message.",
  "校验码类型": "Code type",
  "数字": "Digits",
  "字母": "Letters",
  "数字+字母": "Letters and digits",
  "校验码长度": "Code length",
  "频率（分钟）": "Frequency (minutes)",
  "每日开始时间": "Daily start time",
  "留空表示保存后立即开始。": "Leave blank to start as soon as it is saved.",
  "外部号码": "External recipient",
  "接收号码不在本机模组上，只记录发送结果，不等待回收。": "The recipient is not one of this server's modems, so only the submission is recorded; no delivery is awaited.",
  "调度器每 10 秒检查一次到期的测试计划与待匹配的短信。": "The scheduler checks for due tests and matching inbound messages every 10 seconds.",
  "值": "Value",
  "暂无条目": "No entries",
  ...
  "测试触发失败": "Failed to trigger the test",
  ...
  "对端地址": "Peer address",
  "允许的来源地址或网段": "Allowed source addresses or CIDRs",
  "允许拨打的号码模式，如 _1NXXNXXXXXX": "Permitted destination patterns, e.g. _1NXXNXXXXXX",
  "允许使用的 SIM，用空格分隔": "Permitted SIMs, space separated",
  "生成的配置": "Generated configuration",
  "呼入用户名（可选）": "Inbound username (optional)",
  "呼入密码（保存后不再回显）": "Inbound password (never shown again after saving)",
  ...
  "分机路由": "Extension routes",
  "没有分机路由。没有任何路由时，分机的外呼都会被 Asterisk 拒绝。": "No extension routes. With none configured, outbound calls from extensions are rejected by Asterisk.",
  "外部中继": "External trunks",
  "内部中继": "Internal trunk",
  "没有外部中继端点": "No external trunk endpoints",
  "添加外部中继": "Add external trunk",
  "外部中继可以通过 SIM 卡拨出，产生真实话费。只填写确实需要的目标号码和 SIM 卡。": "An external trunk can dial out through a SIM and spend real money. List only the destinations and SIMs it actually needs.",
  "没有外部中继。外部 SIP 对端无法接入，也无法作为转发目标。": "No external trunks. No external SIP peer can reach this system, and none is available as a forwarding destination.",
  "这些设备已不存在，使用它们的外部中继在拨号时会失败": "These devices no longer exist; external trunks using them will fail at dial time",
  "同时允许使用分机路由（这些呼叫不受上面的 SIM 限制和并发上限约束）": "Also allow the extension routes (those calls escape the SIM list and the cap above)",
  "转发到外部中继": "Forward to an external trunk",
  "还没有配置外部中继。先在上面的「外部中继」中添加一个，保存并应用后才能在这里选择。": "No external trunks configured yet. Add one under External trunks above, save and apply, and it becomes selectable here.",
  "查看前置 PBX 的实时状态：分机注册情况与内外中继可达性": "Live state of the PBX in front: extension registrations, and internal and external trunk reachability",
  "应用": "Apply",
  "正在开启...": "Turning on...",
  "正在关闭...": "Turning off...",
  ...
  "短信路由": "SMS routing",
  "不经过 PBX": "Not through the PBX",
  "按号码收发（分机号即 SIM 号码）": "By number (an extension named after its SIM)",
  "SIM 收到的短信会送到与该 SIM 号码同名的分机，原始发件人保留在 From 中，分机可直接回复。分机发出的短信只有在分机号等于某张 SIM 的号码时才被接受，并由该 SIM 发出；收件人可以是任意号码。": "A text arriving on a SIM is delivered to the extension named after that SIM's number, with the original sender kept in From so the handset can reply to it. A text sent by an extension is accepted only when the extension is a SIM's own number, and goes out through that SIM; the recipient can be any number.",
  "短信只在 VoCat 内处理，不生成任何 Asterisk 短信拨号方案。": "Texts are handled inside VoCat only. No Asterisk SMS dialplan is generated.",
  "还没有配置 SIP 中继，短信无法经过 PBX。请先设置 VOCAT_SIP_TRUNK_ADDR 并重启。": "No SIP trunk is configured, so there is nothing to carry SMS. Set VOCAT_SIP_TRUNK_ADDR and restart first.",
  "生成的短信拨号方案": "Generated SMS dialplan",
  "短信记录": "Message history",
  "仅显示经过 PBX 的短信": "Only texts that crossed the PBX",
  "还没有经过 PBX 的短信": "No texts have crossed the PBX yet",
  "分机收发的短信会出现在这里。": "Texts an extension sends or receives appear here.",
  "会话": "Conversations",
  "选择一个会话": "Pick a conversation",
};
