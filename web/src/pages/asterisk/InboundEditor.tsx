...
import type { AsteriskExtension, AsteriskInbound } from "../../types";
...
// Where a call arriving on a SIM rings. The three modes are exclusive: there
// is no fallback between them, because a fallback is exactly the thing that
// makes "why did that call ring the wrong phone" unanswerable.
